Feature: layout protocol
  ...
  Scenario: tells the layout to register with #register message
    When I start the program with option -r./layout -l Layout
    Then the output will contain current display
